...
default:
	...
	@echo "'make dcl' runs double check lock singleton demo"
...
dcl: bin/DoubleCheckLockSingletonClient.class
	java -cp bin DoubleCheckLockSingletonClient 1000000
	java -cp bin DoubleCheckLockSingletonClient 10000000
	java -cp bin DoubleCheckLockSingletonClient 100000000
